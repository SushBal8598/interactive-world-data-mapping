...
if option != 'Placeholder':
    ...
    with col1:
        ...
        country_df = global_variables.pop_df[global_variables.pop_df['Country Name'] == option]
        country_df_index = int((global_variables.pop_df[global_variables.pop_df['Country Name'] == option].index)[0])
    ...
    with col2:
        ...
        my_data = make_general_sheet(global_variables.gdp_data, 'gdp_df')[make_general_sheet(global_variables.gdp_data, 'gdp_df')['Country Name'] == option]
        gdp_df_index = int(make_general_sheet(global_variables.gdp_data, 'gdp_df')[make_general_sheet(global_variables.gdp_data, 'gdp_df')['Country Name'] == option].index[0])
        try:
